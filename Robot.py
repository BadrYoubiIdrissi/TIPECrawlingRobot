...
class Robot():
    ...
    def __init__(self, bodywidth = 100,
        ...
        self.fric = Box(50,10, self.arm2.body.position + Vec2d(35,-15), 0.1)
...
#        self.gearJoints[2].max_force = 1000000
    ...
    def addtoSpace(self,space):
        space.add(self.mainBody.body,self.mainBody.shape,
                  ...
                  self.pivotJoints[0],self.pivotJoints[1],self.pivotJoints[2],
                    self.gearJoints[0],self.gearJoints[1],self.gearJoints[2])
    def appliquerCouple(self, couple, pivot):
            pivot.b.apply_force_at_local_point((0,couple), (0,0))
            pivot.b.apply_force_at_local_point((0,-couple), (-self.arm1.width,0))
#            force = pivot.b.local_to_world((0,-couple))
#            point = pivot.anchor_a - pivot.b.local_to_world((0,0))
#            pivot.a.apply_force_at_local_point(force, point)
